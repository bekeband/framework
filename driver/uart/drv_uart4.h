/*******************************************************************************
  ...
  Summary:
    This is the header file for UART4 driver
...
/* Function:
  ...
  Precondition:
    DRV_UART4_InitializerDefault function should have been called 
...
/* Function:
  ...
  Returns:
    A DRV_UART4_TRANSFER_STATUS value describing the current status 
    of the transfer.
  ...
  Remarks:
    ...
    specified in the DRV_UART4_TRANSFER_STATUS enumeration set.  
...
/* Function:
  ...
  Returns:
    A DRV_UART4_STATUS value describing the current status 
    of the transfer.
  ...
  Remarks:
    The returned status may contain a value with more than one of the bits
    specified in the DRV_UART4_STATUS enumeration set.  
    The caller should perform an "AND" with the bit of interest and verify if the
    result is non-zero (as shown in the example) to verify the desired status
    bit.
*/
