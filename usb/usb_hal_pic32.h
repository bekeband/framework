...
/****************************************************************
  ...
  ****************************************************************/
#define USBModuleDisable() {U1CON = 0;U1IE = 0;U1OTGIE = 0;U1PWRCbits.USBPWR = 1;\
 ...
 *******************************************************************/
#define DisableNonZeroEndpoints(last_ep_num) {UINT8 i;UINT32 *p = (UINT32*)&U1EP1;\
  for(i=0;i<last_ep_num;i++){*p = 0;p += 4;}}
