...
;  WREG7 - psv table offset
    .global    _AES_RoundKeysCreate192
_AES_RoundKeysCreate192:
.ifndecl __HAS_EDS
    push CORCON
.endif
    mov        PSVPAG, W3
    ...
    repeat #11
    mov     [W1++],[W0++]   ;w0-w5 of the key to the session key
...
_AES_RoundKeysCreate192_Loop:
    ...
    dec        W1, W1
    bra        NZ, _AES_RoundKeysCreate192_Loop
