 ...
 *
 *********************************************************************
 * FileName:        block_cipher_mode_ofb.h
 * Dependencies:    None
...
/* Function:
  ...
  Description:
    Initializes a OFB context for encryption/decryption.  The user will specify 
    details about the algorithm being used in OFB mode.
  ...
  Example:
    ...
    BLOCK_CIPHER_OFB_Initialize (&context, AES_Encrypt, AES_Decrypt, AES_BLOCK_SIZE, initialization_vector, (void *)&keyStream, sizeof (keyStream));
    </code>
*/
...
/**************************************************************************************************************************************************************
  ...
  Description:
    Encrypts plain text using output feedback mode.
  Conditions:
    The OFB context must be initialized with the block cipher
    ...
    The initializationVector parameter in the BLOCK_CIPHER_OFB_CONTEXT
  ...
  Example:
    ...
    BLOCK_CIPHER_OFB_KeyStreamGenerate(handle, 4, &round_keys, &context, BLOCK_CIPHER_OPTION_STREAM_START);

    //Encrypt the data
    BLOCK_CIPHER_OFB_Encrypt (handle, cipher_text,(void *) plain_text, sizeof(plain_text), &round_keys, &context, BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
    </code>
...
/***************************************************************************************************************************************************************
  ...
  Input:
    ...
    context -     Pointer to a context structure for this decryption. The
                  first call of this function should have the
                  context->initializationVector set to the initialization
  ...
  Example:
    ...
    // Decrypt the data
    BLOCK_CIPHER_OFB_Decrypt (handle, plain_text,(void *) cipher_text, sizeof(cipher_text), &round_keys, &context, BLOCK_CIPHER_OPTION_STREAM_CONTINUE);
    </code>
                                                                                                                                                                
  ***************************************************************************************************************************************************************/
BLOCK_CIPHER_ERRORS BLOCK_CIPHER_OFB_Decrypt (DRV_HANDLE handle, uint8_t * plainText, uint8_t * cipherText, uint32_t numBytes, void * key, BLOCK_CIPHER_OFB_CONTEXT * context, uint32_t options);
#define BLOCK_CIPHER_OFB_Decrypt      BLOCK_CIPHER_OFB_Encrypt
...
/* Function:
  ...
  Input:
    ...
    context -    Pointer to a context structure for this operation. The
                 first call of this function should have the
                 context->initializationVector set. This value will be
