        ...
        switch(state)
        {
            ...
            case SCALE_DRAW:
                ...
                if((i % 45) == 0)
                {
                    ...
                    do
                    {
                        strVal[GFX_CONFIG_OBJECT_METER_SCALE_COUNT - j] = (temp % 10) + '0';
                        if(((temp /= 10) == 0) || (j >= GFX_CONFIG_OBJECT_METER_SCALE_COUNT))
                            break;
                        j++;
                    } while(j <= GFX_CONFIG_OBJECT_METER_SCALE_COUNT);
    
                    // the (&strVal[GFX_CONFIG_OBJECT_METER_SCALE_COUNT-j]) removes the leading zeros.
                    // if leading zeroes will be printed change (&strVal[GFX_CONFIG_OBJECT_METER_SCALE_COUNT-j])
            ...
            case VALUE_DRAW:
                ...
                if(GFX_GOL_ObjectStateGet(pMtr, GFX_GOL_METER_ACCURACY_STATE))
                {
                    strVal[GFX_CONFIG_OBJECT_METER_SCALE_COUNT - j] = (((i % GFX_CONFIG_OBJECT_METER_RESOLUTION)) / (GFX_CONFIG_OBJECT_METER_RESOLUTION / 10)) + '0';
                ...
                do
                {
                    strVal[GFX_CONFIG_OBJECT_METER_SCALE_COUNT - j] = (i % 10) + '0';
                    if(((i /= 10) == 0) || (j >= GFX_CONFIG_OBJECT_METER_SCALE_COUNT))
                        break;
                    j++;
                } while(j <= GFX_CONFIG_OBJECT_METER_SCALE_COUNT);
