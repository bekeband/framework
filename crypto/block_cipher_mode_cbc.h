 ...
 *
 *********************************************************************
 * FileName:        block_cipher_mode_cbc.h
 * Dependencies:    None
...
typedef struct
{
    uint8_t __attribute__((aligned)) initializationVector[CRYPTO_CONFIG_BLOCK_MAX_SIZE];      // Initialization vector for the CBC operation
...
/* Function:
  ...
  Example:
    ...
    BLOCK_CIPHER_CBC_Initialize (&context, AES_Encrypt, AES_Decrypt, AES_BLOCK_SIZE, initialization_vector);
    </code>
*/
...
/**************************************************************************************************************************************************************************************
  ...
  Example:
    ...
    //Encrypt the data
    BLOCK_CIPHER_CBC_Encrypt (handle, cipher_text, &num_bytes_encrypted, (void *) plain_text, sizeof(plain_text), &round_keys, &context, BLOCK_CIPHER_OPTION_STREAM_START);
    </code>
...
/* Function:
  ...
  Example:
    ...
    // Decrypt the data
    BLOCK_CIPHER_CBC_Decrypt (handle, plain_text, &num_bytes_decrypted, (void *) cipher_text, sizeof(cipher_text), &round_keys, &context, BLOCK_CIPHER_OPTION_STREAM_START);
    </code>
*/
